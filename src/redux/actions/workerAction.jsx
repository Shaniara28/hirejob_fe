...
export const getWorkers = (setWorker) => async (dispatch) => {
  try {
    axios.get(`${process.env.API_BACKEND}workers`).then((response) => {
...
export const getDetailWorker = (setWorker, id) => async (dispatch) => {
  try {
    if (id) {
      axios.get(`${process.env.API_BACKEND}workers/${id}`).then((response) => {
...
export const updateWorker = (worker, id) => async (dispatch) => {
  ...
  console.log(worker);
  try {
    axios.put(`${process.env.API_BACKEND}workers/${id}`, worker).then((res) => {
